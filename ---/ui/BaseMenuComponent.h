#ifndef _BASEMENUCOMPONENT_H_
#define _BASEMENUCOMPONENT_H_
...
// BaseMenuComponent combines appropriate Controller, View and Model.
...
protected:
    ...
    // Parent component.
    BaseMenuComponent* parent;

    // List of children, if any.
    std::vector<BaseMenuComponent*> children;

    // Current child.
    BaseMenuComponent* curChild;
    int8_t curChildIndex;

    // Active child.
    BaseMenuComponent* activeChild;
    int8_t activeChildIndex;

public:
    BaseMenuComponent(Controller* controller, View* view, Model* model, SystemFacade* facade);
    ...
    BaseMenuComponent* getParent() const
    {
        return parent;
    }

    void setParent(BaseMenuComponent* parent)
    {
        parent = parent;
    }
    ...
    void addChildren(BaseMenuComponent* child)
    {
